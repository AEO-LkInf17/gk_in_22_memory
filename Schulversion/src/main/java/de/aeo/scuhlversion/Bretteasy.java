 ...
 * @author schueler
 */
public class Bretteasy extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bretteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
